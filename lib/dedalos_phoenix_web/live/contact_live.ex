defmodule DedalosPhoenixWeb.ContactLive do
        ...
        <div className="row">
          <div className="col-md-8 wow bounceInLeft" data-wow-delay="0.3s">
            ...
            <div className="form-group col-xs-12">
              <button class="btn btn-common btn-lg btn-block" name="submit" id="form-submit" type="submit"><i className="fa fa-envelope"></i> Enviar</button>
            </div>
          </form>
          </div>
          ...
          <div className="col-md-4 clearfix wow bounceInRight" data-wow-delay="0.4s">
            ...
            <div className="contact-info2 mt-30">
              <h2 className="small-title">Información de Contacto</h2>
              <ul className="contact-info2">
                ...
                <li>
                  <p><strong><i className="fa fa-envelope"></i> Escríbanos:</strong> <a href="mailto:biblioteca@ccpadrevarela.org">biblioteca@ccpadrevarela.org</a></p>
                </li>
                <li>
